...
\begin{frame}{Scope}
\begin{itemize}
	\item \textbf{Purpose:} definition of vocabulary and rules -> document semantics of business vocabularies and business rules
	\item \textbf{Goal:}
	\begin{itemize}
		\item exchange of voc and rules between organizations and software tools 
		\item make business rules readable for non-IT people
	\end{itemize}
\end{itemize}
\end{frame}
...
\begin{frame}{How?}
	\begin{itemize}
        \item{Vocabulary}
		\item{Semantic rules concerning vocabulary}
	\end{itemize}
\end{frame}
...
\section{Definitions}
\begin{frame}{Important Aspects}
	\begin{itemize}
		\item Formal logic
		\item Recognition of user sub-communities
		\item Body of shared meanings
		\item Logic-based formulation allowing multiple representation forms
		\item Business representation of the logical formulation of the semantics that is non-ambiguous for all sub-communities 
	\end{itemize}
\end{frame}
    
\begin{frame}{Model Building Blocks}
	\begin{enumerate}
		\item Vocabularies and terminology dictionaries
		\item Noun and verb concepts
		\item Definitional and operational business rules
	\end{enumerate}
\end{frame}

\begin{frame}{Vocabularies and terminological dictionaries}
\end{frame}

\begin{frame}{Noun and verb concepts}
\end{frame}

\begin{frame}{Definitional and operational business rules}
\end{frame}

\begin{frame}{Expansion: Creating custom vocabularies}
	\includegraphics[scale=0.20]{assets/custom.png}
\end{frame}
\section{Dank voor uw aandacht}
\end{document}\grid
